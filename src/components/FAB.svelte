...
<div data-dial-init class="fixed lg:top-16 top-20 right-6 group">
    <button type="button" data-dial-toggle="speed-dial-menu-top-right" aria-controls="speed-dial-menu-top-right" aria-expanded="false" class="flex justify-center items-center w-14 h-14 text-light-text dark:text-dark-text bg-light-secondary rounded-full hover:bg-light-accent dark:bg-dark-secondary dark:hover:bg-dark-accent focus:ring-4 focus:outline-none">
